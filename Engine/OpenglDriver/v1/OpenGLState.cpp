...
FSamplerStateRHIRef FOpenGLDynamicRHI::RHICreateSamplerState(const FSamplerStateInitializerRHI& Initializer)
{
	...
	glSamplerParameteri(SamplerState->Resource, GL_TEXTURE_WRAP_R, SamplerState->Data.WrapR);
	...
	glSamplerParameteri(SamplerState->Resource, GL_TEXTURE_COMPARE_MODE, SamplerState->Data.CompareMode);
	glSamplerParameteri(SamplerState->Resource, GL_TEXTURE_COMPARE_FUNC, SamplerState->Data.CompareFunc);
	

	return FSamplerStateRHIRef(SamplerState);
}
...
FRasterizerStateRHIRef FOpenGLDynamicRHI::RHICreateRasterizerState(const FRasterizerStateInitializerRHI& Initializer)
{
	...
	return FRasterizerStateRHIRef(RasterizerState);
}
...
FDepthStencilStateRHIRef FOpenGLDynamicRHI::RHICreateDepthStencilState(const FDepthStencilStateInitializerRHI& Initializer)
{
	...
	return FDepthStencilStateRHIRef(DepthStencilState);
}
...
//	FShaderCache::LogBlendState(Initializer, BlendState);
	return FBlendStateRHIRef(BlendState);
}
