...
#define UGL_REQUIRED_VOID			{ Logger::WriteErrorLog("__FUNCTION__ is not supported."); }
#define UGL_REQUIRED(ReturnValue)	{ Logger::WriteErrorLog("__FUNCTION__ is not supported."); return (ReturnValue); }
...
public:
	...
	static void ProcessExtensions(const string& ExtensionsString);
	...
	static FORCEINLINE GLint GetMaxTextureImageUnits() { assert(MaxTextureImageUnits != -1); return MaxTextureImageUnits; }
	static FORCEINLINE GLint GetMaxVertexTextureImageUnits() { assert(MaxVertexTextureImageUnits != -1); return MaxVertexTextureImageUnits; }
	static FORCEINLINE GLint GetMaxGeometryTextureImageUnits() { assert(MaxGeometryTextureImageUnits != -1); return MaxGeometryTextureImageUnits; }
	static FORCEINLINE GLint GetMaxHullTextureImageUnits() { assert(MaxHullTextureImageUnits != -1); return MaxHullTextureImageUnits; }
	static FORCEINLINE GLint GetMaxDomainTextureImageUnits() { assert(MaxDomainTextureImageUnits != -1); return MaxDomainTextureImageUnits; }
	static FORCEINLINE GLint GetMaxComputeTextureImageUnits() { return 0; }
	static FORCEINLINE GLint GetMaxCombinedTextureImageUnits() { assert(MaxCombinedTextureImageUnits != -1); return MaxCombinedTextureImageUnits; }
	...
	static FORCEINLINE GLint GetMaxVaryingVectors() { assert(MaxVaryingVectors != -1); return MaxVaryingVectors; }
	static FORCEINLINE GLint GetMaxPixelUniformComponents() { assert(MaxPixelUniformComponents != -1); return MaxPixelUniformComponents; }
	static FORCEINLINE GLint GetMaxVertexUniformComponents() { assert(MaxVertexUniformComponents != -1); return MaxVertexUniformComponents; }
	static FORCEINLINE GLint GetMaxGeometryUniformComponents() { assert(MaxGeometryUniformComponents != -1); return MaxGeometryUniformComponents; }
	static FORCEINLINE GLint GetMaxHullUniformComponents() { assert(MaxHullUniformComponents != -1); return MaxHullUniformComponents; }
	static FORCEINLINE GLint GetMaxDomainUniformComponents() { assert(MaxDomainUniformComponents != -1); return MaxDomainUniformComponents; }
