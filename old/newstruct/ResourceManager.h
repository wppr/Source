...
public:
	...
	as_ResourceManager<as_Mesh*> as_meshManager;
	as_ResourceManager<as_Geometry*> as_geometryManager;
	as_ResourceManager<as_Skeleton*> as_skeletonManager;
	as_ResourceManager<as_SkeletonAnimation*> as_skeletonAniManager;
	as_ResourceManager<as_Material*> as_materialManager;
	as_ResourceManager<as_Texture*>	as_textureManager;
