...
namespace HW
{
	...
	public:
		...
		*/
		virtual void SetBackground(const Vector4& background) {m_BKColor = background;}
		/** 
		*/
		...
		*/
		virtual void BufferSwap();
		/** clear frame buffer,input bitwise #FrameBuffer
		*/
		virtual void ClearBuffer(unsigned int buffer);
		...
		*/
		...
		/** 
		*/
		virtual RenderTarget* CurrentRenderTarget()const ;
		...
		/* set polygonoffset .default = false
		*/
		...
		public:
			...
			void GetWandHEGL(int & w,int &height);
#endif
	};
#ifndef ANDROID
